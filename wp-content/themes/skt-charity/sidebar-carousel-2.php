<?php
    ...
    $sidebar_id = "carousel-widget-container-2";
...
<div class="partenrsPage" style="<?php echo $background ?>" >
    ...
    <div id="myCarousel2" class="carousel carousel-fade slide partnersPage" data-ride="carousel" > 
        <ol id="myCarouselIndicator2" class="carousel-indicators">
        </ol>

        <div id="myCarousel2Inner" class="carousel-inner">
