...
( function( $ ) {
	/* Company text logo */
	wp.customize( 'ccc_text_logo', function( value ) {
		value.bind( function( newval ) {
			if( wp.customize._value.ccc_img_logo() == '' ) {
	...
	/* Company image logo */
	wp.customize( 'ccc_img_logo', function( value ) {
		value.bind( function( newval ) {
			if( newval !== '' ) {
				$( '#header .top-header .header-logo' ).empty();
				$( '#header .top-header .header-logo' ).prepend( '<img src="" alt="'+ wp.customize._value.ccc_text_logo +'" title="'+ wp.customize._value.ccc_text_logo +'" />' );
				$( '#header .top-header .header-logo img' ).attr( 'src', newval );
			} else {
				$( '#header .top-header .header-logo' ).text( wp.customize._value.ccc_text_logo() );
			}
		} );
	} );

	/* Facebook URL */
	wp.customize( 'ccc_contact_bar_facebook_url', function( value ) {
		value.bind( function( newval ) {
	...
	/* Twitter URL */
	wp.customize( 'ccc_contact_bar_twitter_url', function( value ) {
		value.bind( function( newval ) {
	...
	/* LinkedIn URL */
	wp.customize( 'ccc_contact_bar_linkedin_url', function( value ) {
		value.bind( function( newval ) {
	...
	/* email */
	wp.customize( 'ccc_email', function( value ) {
		value.bind( function( newval ) {
	...
	/* phone number */
	wp.customize( 'ccc_phone', function( value ) {
		value.bind( function( newval ) {
	...
	// Address 1
	wp.customize( 'ccc_address1', function( value ) {
		value.bind( function( newval ) {
	...
	// Address 1
	wp.customize( 'ccc_address2', function( value ) {
		value.bind( function( newval ) {
	...
	/* Footer Image Logo */
	wp.customize( 'ccc_img_footer_logo', function( value ) {
		value.bind( function( newval ) {
			if( newval !== '' ) {
	...
	/* Footer Copyright */
	wp.customize( 'ccc_footer_copyright', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'ccc_general_footer_display_copyright', function( value ) {
		value.bind( function( newval ) {
			if( newval == true ) {
	...
	wp.customize( 'ccc_enable_post_posted_on_blog_posts', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	wp.customize( 'ccc_enable_post_tags_blog_posts', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	wp.customize( 'ccc_enable_post_comments_blog_posts', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	wp.customize( 'ccc_enable_author_box_blog_posts', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	/* Facebook visibility */
	wp.customize( 'ccc_facebook_visibility', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	/* Twitter visibility */
	wp.customize( 'ccc_twitter_visibility', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	/* LinkedIN visibility */
	wp.customize( 'ccc_linkein_visibility', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	// Image
	// wp.customize( 'ccc_jumbotron_general_image', function( value ) {
	// 	value.bind( function( newval ) {
	// 		if( newval == '' ) {
	...
	wp.customize( 'ccc_jumbotron_general_first_row_from_title', function( value ) {
		value.bind( function( newval ) {
			if( newval == '' ) {
	...
	wp.customize( 'ccc_jumbotron_general_second_row_from_title', function( value ) {
		value.bind( function( newval ) {
			if( newval == '' ) {
	...
	wp.customize( 'ccc_jumbotron_general_third_row_from_title', function( value ) {
		value.bind( function( newval ) {
	...
	// Entry
	wp.customize( 'ccc_jumbotron_general_entry', function( value ) {
		value.bind( function( newval ) {
	...
	// First button text
	wp.customize( 'ccc_jumbotron_general_first_button_title', function( value ) {
		value.bind( function( newval ) {
			if ( newval == false ) {
	...
	// First button URL
	wp.customize( 'ccc_jumbotron_general_first_button_url', function( value ) {
		value.bind( function( newval ) {
	...
	// Second button text
	wp.customize( 'ccc_jumbotron_general_second_button_title', function( value ) {
		value.bind( function( newval ) {
			if ( newval == false ) {
	...
	// Second button URL
	wp.customize( 'ccc_jumbotron_general_second_button_url', function( value ) {
		value.bind( function( newval ) {
	...
	// Show this section
	wp.customize( 'ccc_about_general_show', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	// Title
	wp.customize( 'ccc_about_general_title', function( value ) {
		value.bind( function( newval ) {
	...
	// Entry
	wp.customize( 'ccc_about_general_entry', function( value ) {
		value.bind( function( newval ) {
	...
	// Show this section
	wp.customize( 'ccc_projects_general_show', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	// Title
	wp.customize( 'ccc_projects_general_title', function( value ) {
		value.bind( function( newval ) {
	...
	// Entry
	wp.customize( 'ccc_projects_general_entry', function( value ) {
		value.bind( function( newval ) {
	...
	// Show this section
	wp.customize( 'ccc_testimonials_general_show', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	// Title
	wp.customize( 'ccc_testimonials_general_title', function( value ) {
		value.bind( function( newval ) {
	...
	// Background Image
	wp.customize( 'ccc_testimonials_general_background_image', function( value ) {
		value.bind( function( newval ) {
			if( newval == '' ) {
	...
	// Show this section
	wp.customize( 'ccc_services_general_show', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	// Title
	wp.customize( 'ccc_services_general_title', function( value ) {
		value.bind( function( newval ) {
	...
	// Entry
	wp.customize( 'ccc_services_general_entry', function( value ) {
		value.bind( function( newval ) {
	...
	// Show this section
	wp.customize( 'ccc_latest_news_general_show', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	// Title
	wp.customize( 'ccc_latest_news_general_title', function( value ) {
		value.bind( function( newval ) {
	...
	// Entry
	wp.customize( 'ccc_latest_news_general_entry', function( value ) {
		value.bind( function( newval ) {
	...
	// Button Text
	wp.customize( 'ccc_latest_news_button_text', function( value ) {
		value.bind( function( newval ) {
	...
	// Button URL
	wp.customize( 'ccc_latest_news_button_url', function( value ) {
		value.bind( function( newval ) {
	...
	// Show this section
	wp.customize( 'ccc_counter_general_show', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	// Type of Background
	wp.customize( 'ccc_counter_background_type', function( value ) {
		value.bind( function( newval ) {
			if( newval == 'image' ) {
				$( '#counter' ).css( 'background-image', 'url('+ wp.customize._value.ccc_counter_background_image() +')' );
			} else if( newval == 'color' ) {
				$( '#counter' ).css( 'background-image', '' );
				$( '#counter' ).css( 'background-color', 'color:' + wp.customize._value.ccc_counter_background_color() );
			}
		} );
	} );

	// Image
	wp.customize( 'ccc_counter_background_image', function( value ) {
		value.bind( function( newval ) {
			if( newval == '' ) {
				$( '#counter' ).css( 'background-image', '' );
			} else {
	...
	// Color
	wp.customize( 'ccc_counter_background_color', function( value ) {
		value.bind( function( newval ) {
	...
	// Show this section
	wp.customize( 'ccc_team_general_show', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	// Title
	wp.customize( 'ccc_team_general_title', function( value ) {
		value.bind( function( newval ) {
	...
	// Entry
	wp.customize( 'ccc_team_general_entry', function( value ) {
		value.bind( function( newval ) {
	...
	// Show this section
	wp.customize( 'ccc_contact_us_show', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	// Title
	wp.customize( 'ccc_contact_us_general_title', function( value ) {
		value.bind( function( newval ) {
	...
	// Entry
	wp.customize( 'ccc_contact_us_general_entry', function( value ) {
		value.bind( function( newval ) {
	...
	// Address Title
	wp.customize( 'ccc_contact_us_general_address_title', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'ccc_contact_us_general_customer_support_title', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize.bind('preview-ready', function () {
		wp.customize.preview.bind('update-inline-css', function (object) {
			...
			jQuery.ajax({
				...
				complete: function (json) {
					...
					var style = $('#ccc-main-inline-css');

					if ( !style.length ) {
						style = $('head').append('<style type="text/css" id="ccc-main-inline-css" />').find('#ccc-main-inline-css');
					}
		...
		wp.customize.preview.bind('update-section-css', function (object) {
			var ccc_templates = {};
			var template = '#ccc-'+object.ccc_section+'-section';
			var h_t = Handlebars.compile($(template).text());
			var html = h_t(object.values);
			var style = $('#ccc-'+object.ccc_section+'-section-css');
			if ( !style.length ) {
				style = $('head').append('<style type="text/css" id="ccc-'+object.ccc_section+'-section-css" />').find('#ccc-'+object.ccc_section+'-section-css');
			}
