...
(function(api) {
    // Extends our custom "ccc-pro-section" section.
    api.sectionConstructor['ccc-pro-section'] = api.Section.extend({
    ...
    // Extends our custom "ccc-pro-section" section.
    api.sectionConstructor['ccc-recomended-section'] = api.Section.extend({
        // No events for this type of section.
        attachEvents: function() {},
        // Always make the section active.
        isContextuallyActive: function() {
...
jQuery(document).ready(function($) {
    function ccc_sections_order(container) {
        var sections = $('#sub-accordion-panel-homepage_customizer').sortable('toArray');
        var s_ordered = [];
        ...
        $.ajax({
            url: CCCCustomizer.ajax_url,
            type: 'post',
            dataType: 'html',
            data: {
                'action': 'ccc_order_sections',
                'sections': s_ordered,
            }
        }).done(function(data) {
    ...
    $('.recomended-actions_container').on('actions_complete', function(evt, element) {
        if ($(element).next('.epsilon-recommeded-actions-container').length > 0) {
            ...
            $('.control-section-ccc-recomended-section .ccc-actions-count .current-index').text(next_index);
            $(element).remove();
        } else {
            $(element).remove();
            $('.control-section-ccc-recomended-section .ccc-actions-count').remove();
            $('.control-section-ccc-recomended-section .accordion-section-title .section-title').text($('.control-section-ccc-recomended-section .accordion-section-title .section-title').data('succes'))
    ...
    $('#sub-accordion-panel-homepage_customizer').sortable({
        helper: 'clone',
        items: '> li.control-section:not(#accordion-section-ccc_jumbotron_general)',
        cancel: 'li.ui-sortable-handle.open',
        delay: 150,
        update: function(event, ui) {
            ccc_sections_order($('#sub-accordion-panel-homepage_customizer'));
        },
    });
    // Textarea editor
    function _the_editor(container) {
        var _editor = {
            ready: function(container) {
                ...
                control.container.addClass('ccc-editor-added');
...
(function($) {
            ...
            switch (id) {
                ...
                case 'customize-control-sidebars_widgets-front-page-about-sidebar':
                    $.each(widgetList, function($k, $v) {
                        ...
                        if (individualId.search('ccc_skill') == -1) {
                            $(this).hide();
                ...
                case 'customize-control-sidebars_widgets-front-page-projects-sidebar':
                    $.each(widgetList, function($k, $v) {
                        var individualId = $(this).attr('data-widget-id');
                        if (individualId.search('ccc_project') == -1) {
                            $(this).hide();
                            search.attr('disabled', true);
                        }
                    });
                ...
                case 'customize-control-sidebars_widgets-front-page-services-sidebar':
                    $.each(widgetList, function($k, $v) {
                        var individualId = $(this).attr('data-widget-id');
                        if (individualId.search('ccc_service') == -1) {
                            $(this).hide();
                            search.attr('disabled', true);
                        }
                    });
                ...
                case 'customize-control-sidebars_widgets-front-page-counter-sidebar':
                    $.each(widgetList, function($k, $v) {
                        var individualId = $(this).attr('data-widget-id');
                        if (individualId.search('ccc_counter') == -1) {
                            $(this).hide();
                            search.attr('disabled', true);
                        }
                    });
                ...
                case 'customize-control-sidebars_widgets-front-page-team-sidebar':
                    $.each(widgetList, function($k, $v) {
                        var individualId = $(this).attr('data-widget-id');
                        if (individualId.search('ccc_person') == -1) {
                            $(this).hide();
                            search.attr('disabled', true);
                        }
                    });
                ...
                default:
                    $.each(widgetList, function($k, $v) {
                        ...
                        var individualId = $(this).attr('data-widget-id');
                        if (individualId.search('ccc_person') != -1 || individualId.search('ccc_counter') != -1 || individualId.search('ccc_service') != -1 || individualId.search('ccc_skill') != -1 || individualId.search('ccc_project') != -1 || individualId.search('ccc_recent_posts') != -1) {
                            $(this).hide();
                        } else {
                            $(this).show();
                        }
    ...
    // Sections css
    var sections = {
        'jumbotron': ['ccc_jumbotron_general_image', 'ccc_jumbotron_general_color', 'ccc_jumbotron_first_button_background', 'ccc_jumbotron_second_button_background', 'ccc_jumbotron_second_button_background_hover', 'ccc_jumbotron_title_color', 'ccc_jumbotron_points_color', 'ccc_jumbotron_descriptions_color', 'ccc_jumbotron_first_button_color', 'ccc_jumbotron_right_button_color', 'ccc_jumbotron_background_size', 'ccc_jumbotron_background_repeat', 'ccc_jumbotron_background_attachment', 'ccc_jumbotron_background_position_y', 'ccc_jumbotron_background_position_x'],
        'latestnews': ['ccc_latest_news_title_color', 'ccc_latest_news_descriptions_color', 'ccc_latest_news_general_color', 'ccc_latest_news_button_background', 'ccc_latest_news_button_background_hover', 'ccc_latest_news_button_color', 'ccc_latest_news_post_bakground_color', 'ccc_latest_news_post_text_color', 'ccc_latest_news_post_text_hover_color', 'ccc_latest_news_post_content_color', 'ccc_latest_news_post_button_color', 'ccc_latest_news_post_button_hover_color', 'ccc_latest_news_general_image', 'ccc_latest_news_background_size', 'ccc_latest_news_background_repeat', 'ccc_latest_news_background_attachment', 'ccc_latest_news_background_position_y', 'ccc_latest_news_background_position_x'],
        'fullwidth': ['ccc_full_width_title_color', 'ccc_full_width_descriptions_color', 'ccc_full_width_general_color', 'ccc_full_width_full_text', 'ccc_full_width_general_image', 'ccc_full_width_background_size', 'ccc_full_width_background_repeat', 'ccc_full_width_background_attachment', 'ccc_full_width_background_position_y', 'ccc_full_width_background_position_x'],
        'about': ['ccc_about_title_color', 'ccc_about_descriptions_color', 'ccc_about_general_color', 'ccc_about_general_image', 'ccc_about_background_size', 'ccc_about_background_repeat', 'ccc_about_background_attachment', 'ccc_about_background_position_y', 'ccc_about_background_position_x'],
        'projects': ['ccc_projects_title_color', 'ccc_projects_descriptions_color', 'ccc_projects_general_color', 'ccc_projects_general_image', 'ccc_projects_background_size', 'ccc_projects_background_repeat', 'ccc_projects_background_attachment', 'ccc_projects_background_position_y', 'ccc_projects_background_position_x'],
        'services': ['ccc_services_title_color', 'ccc_services_descriptions_color', 'ccc_services_general_color', 'ccc_services_general_image', 'ccc_services_background_size', 'ccc_services_background_repeat', 'ccc_services_background_attachment', 'ccc_services_background_position_y', 'ccc_services_background_position_x'],
        'testimonials': ['ccc_testimonials_title_color', 'ccc_testimonials_general_color', 'ccc_testimonials_general_background_image', 'ccc_testimonials_background_size', 'ccc_testimonials_background_repeat', 'ccc_testimonials_background_attachment', 'ccc_testimonials_author_text_color', 'ccc_testimonials_text_color', 'ccc_testimonials_container_background_color', 'ccc_testimonials_dots_color', 'ccc_testimonials_background_position_y', 'ccc_testimonials_background_position_x'],
        'team': ['ccc_team_title_color', 'ccc_team_descriptions_color', 'ccc_team_general_color', 'ccc_team_general_image', 'ccc_team_background_size', 'ccc_team_background_repeat', 'ccc_team_background_attachment', 'ccc_team_background_position_y', 'ccc_team_background_position_x'],
    };

    function ccc_hexToRgbA(hex, opacity) {
        var c;
    ...
    function update_jumbotron_css() {
        var liveObj = {
            'action': 'ccc_generate_section_css',
            'ccc_section': 'jumbotron',
            'values': {}
        };
        _.each(sections.jumbotron, function(setting) {
            liveObj.values[setting] = wp.customize(setting)();
        });
        if (liveObj.values.ccc_jumbotron_first_button_background !== undefined) {
            var color = liveObj.values.ccc_jumbotron_first_button_background;
            liveObj.values.ccc_jumbotron_first_button_background = ccc_hexToRgbA(color, '.2');
            liveObj.values.ccc_jumbotron_first_button_background_hover = ccc_hexToRgbA(color, '.1');
            liveObj.values.ccc_jumbotron_first_border_color = ccc_hexToRgbA(color, '1');
        }
...
jQuery(document).ready(function() {
    jQuery(".ccc-dismiss-required-action").click(function() {
        var id = jQuery(this).attr('id'),
            action = jQuery(this).attr('data-action');
        jQuery.ajax({
            type: "GET",
            data: {
                action: 'ccc_dismiss_required_action',
                id: id,
                todo: action
            },
            dataType: "html",
            ...
            beforeSend: function(data, settings) {
                jQuery('#' + id).parent().append('<div id="temp_load" style="text-align:center"><img src="' + CCCCustomizer.template_directory + '/inc/admin/welcome-screen/img/ajax-loader.gif" /></div>');
            },
            success: function(data) {
                var container = jQuery('#' + data).parent().parent();
                var index = container.next().data('index');
                jQuery('.ccc-actions-count .current-index').text(index);
                container.slideToggle().remove();
                if (jQuery('.recomended-actions_container > .epsilon-required-actions').length == 0) {
                    jQuery('#accordion-section-ccc-recomended-section .ccc-actions-count').remove();
                    if (jQuery('.recomended-actions_container > .epsilon-recommended-plugins').length == 0) {
                        ...
                        jQuery('#accordion-section-ccc-recomended-section .section-title').text(jQuery('#accordion-section-ccc-recomended-section .section-title').data('social'));
                    } else {
                        jQuery('#accordion-section-ccc-recomended-section .section-title').text(jQuery('#accordion-section-ccc-recomended-section .section-title').data('plugin_text'));
                    }
                }
            },
    ...
    jQuery(".ccc-recommended-plugin-button").click(function() {
        var id = jQuery(this).attr('id'),
            action = jQuery(this).attr('data-action');
        jQuery.ajax({
            type: "GET",
            data: {
                action: 'ccc_dismiss_recommended_plugins',
                id: id,
                todo: action
            },
            dataType: "html",
