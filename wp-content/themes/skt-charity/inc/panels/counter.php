...
$wp_customize->add_section( $prefix . '_counter_general' ,
    array(
        'priority'      => ccc_get_section_position($prefix . '_counter_general'),
        'title'         => __( 'Counter Section', 'ccc' ),
        'description'   => __( '*In order to get this section to show up on the front-page, make sure you have: 1) enabled static front-page & 2) have a widget placed in this sidebar. More specifically go to Widgets -> Front page - counter sidebar & place the [CCC] - Counter widget in here.', 'ccc' ),
...
$wp_customize->add_setting( $prefix . '_counter_background_type', array(
    'default'           => 'image',
    'sanitize_callback' => 'ccc_sanitize_radio_buttons',
    'transport'         => 'postMessage'
) );
$wp_customize->add_control( $prefix . '_counter_background_type', array(
    'label'     => __( 'Type of Background', 'ccc' ),
    'section'   => $prefix .'_counter_general',
