	...
	class Epsilon_Color_Scheme {
		...
		public function get_customizer_controls() {
			return array(
				'epsilon_accent_color' => array(
					'label'       => __( 'Accent Color', 'ccc' ),
					'description' => __( 'The main color used in CCC.', 'ccc' ),
					'default'     => '#f1d204',
					'section'     => 'colors'
				),
				'epsilon_secondary_accent_color' => array(
					'label'       => __( 'Secondary Accent Color', 'ccc' ),
					'description' => __( 'The secondary color used in CCC.', 'ccc' ),
					'default'     => '#f18b6d',
					'section'     => 'colors'
				),
				'epsilon_text_color' => array(
					'label'       => __( 'Text Color', 'ccc' ),
					'description' => __( 'The color used for headings.', 'ccc' ),
					'default'     => '#545454',
					'section'     => 'colors'
				),
				
				'epsilon_contrast_color' => array(
					'label'       => __( 'Contrast Color', 'ccc' ),
					'description' => __( 'The color used for paragraphs.', 'ccc' ),
					'default'     => '#8c9597',
					'section'     => 'colors'
				),
				'epsilon_hover_color' => array(
					'label'       => __( 'Hover Color', 'ccc' ),
					'description' => __( 'The color used for hover on elements.', 'ccc' ),
					'default'     => '#6a4d8a',
					'section'     => 'colors'
				),
			);
		...
		public function css_template() {
			...
			$css = '
				...
				.widget_rss cite,
				.ccc_home_parallax h3 { color: %3$s; }
			';
			return $css;
		}
		/**
		...
		public function enqueue() {
			...
			wp_add_inline_style( 'ccc-main', $css );
		}
		/**
