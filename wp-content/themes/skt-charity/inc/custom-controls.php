 ...
 */
if( !class_exists( 'CCC_CF7_Custom_Control' ) ) {
    class CCC_CF7_Custom_Control extends WP_Customize_Control {
        /**
        ...
        * @return bool
        ...
        public function ccc_get_cf7_forms() {
            global $wpdb;
            ...
            if ( $this->active_callback()) {
                ...
                if ($cf7) {
                    ...
                    $contact_forms[0] = __('No contact forms found', 'ccc');
                }
            }
        ...
        public function render_content() {
            $Pixova_Lite_contact_forms = $this->ccc_get_cf7_forms();

            if ( !empty($Pixova_Lite_contact_forms ) ) { ?>
                <span class="customize-control-title"><?php echo esc_html($this->label); ?></span>
                <select <?php esc_url($this->link()); ?> style="width:100%;">
                <?php echo '<option value="default">'.__('Select your contact form', 'ccc').'</option>';
 ...
 *  Custom Control: Text
 */
if( !class_exists( 'CCC_Text_Custom_Control' ) ) {
    class CCC_Text_Custom_Control extends WP_Customize_Control {
        public function render_content() {
            $output = '';
