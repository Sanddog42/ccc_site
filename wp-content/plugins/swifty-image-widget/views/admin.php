...
<p style="<?php echo $custom_display; ?>">
	...
	<input id="<?php echo $this->get_field_id( 'img_width' ); ?>" type="text" name="<?php echo $this->get_field_name( 'img_width' ); ?>" value="<?php echo absint($instance['img_width']); ?>" class="small-text" /> $
